<?php
    $id = isset($this->arrParams["form"]["id"])? $this->arrParams["form"]["id"] : "";
    ...
    switch ($this->arrParams['action']) {
        ...
        case 'profile':
            ...
            break;
        case 'confirmCart':
            $strButton  = $btnPublish. $btnUnPublish;
            break;
    }
?>
<div id="toolbar-box">
            <div class="m">
                ...
                <!-- TITLE -->
                <div class="pagetitle icon-48-user"><h2><?php echo $this->_title;?></h2></div>
            </div>
        </div>